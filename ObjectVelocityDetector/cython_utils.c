...
static PyMethodDef __pyx_mdef_12cython_utils_1tonumpyarray = {"tonumpyarray", (PyCFunction)__pyx_pw_12cython_utils_1tonumpyarray, METH_VARARGS|METH_KEYWORDS, 0};
 ...
 *     cdef ar[np.uint8_t, ndim=2] new = np.empty((h, w), dtype=np.uint8)
 */
  __pyx_tuple__10 = PyTuple_Pack(8, __pyx_n_s_xy, __pyx_n_s_height, __pyx_n_s_width, __pyx_n_s_i, __pyx_n_s_j, __pyx_n_s_h, __pyx_n_s_w, __pyx_n_s_new); if (unlikely(!__pyx_tuple__10)) __PYX_ERR(0, 8, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__10);
  __Pyx_GIVEREF(__pyx_tuple__10);
  __pyx_codeobj__11 = (PyObject*)__Pyx_PyCode_New(3, 0, 8, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__10, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_cython_utils_pyx, __pyx_n_s_tonumpyarray, 8, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__11)) __PYX_ERR(0, 8, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
